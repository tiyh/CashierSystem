package com.kupanet.leaf.component.impl;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.kupanet.leaf.component.ZookeeperHelper;
import com.kupanet.leaf.utils.NetUtils;
...
@Component
public class ZookeeperHelperImpl implements ZookeeperHelper {
    private static final Logger LOGGER = LoggerFactory.getLogger(ZookeeperHelperImpl.class);
            ...
            if (stat == null) {
                ...
                if (workerid != null) {
                    ...
                    if (!checkInitTimeStamp(curator, zk_AddressNode)) {
                        throw new IllegalArgumentException("init timestamp check error,forever node timestamp gt this node time");
                    }
                    //准备创建临时节点
                    doService(curator);
                    //updateLocalWorkerID(workerID);
